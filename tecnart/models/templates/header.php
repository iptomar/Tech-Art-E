...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Merriweather+Sans:wght@700&family=PT+Sans&display=swap"
        rel="stylesheet">
            ...
            <div style="padding-top: 0px;" class="container">
                        ...
                        <nav class="navbar navbar-expand custom_nav-container lang_nav">
                            ...
                            <ul class="navbar-nav">
                                <li style="margin-top: 40px; overflow:visible;" class="nav-item">
                                    <div>
                                        <a href="javascript:void(0);" class="translationOption"
                                            style="font-weight: <?= $ptWeight ?>" data-value="pt"
                                            onclick="updateSessionAndRefresh(this)">PT</a>
                                        <a href="javascript:void(0);" class="translationOption"
                                            style="font-weight: <?= $enWeight ?>" data-value="en"
                                            onclick="updateSessionAndRefresh(this)">EN</a>
                                    </div>
                                </li>
                ...
                <nav style="padding-top: 0px;" class="navbar navbar-expand-lg custom_nav-container ">
                    ...
                    <div id="logo" style="max-width:350px; width:85%;">
                        <a class="navbar-brand" href="index.php"><img class="w-100"
                                src="<?= change_lang("header-site-logo") ?>" alt="#" /></a>
                        <!--Logo que redireciona para o index.html-->
                    </div>
                    ...
                    <div style="padding-top: 0px;" class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link" id="nav_drop" href="sobre.php" role="button" aria-haspopup="true"
                                    aria-expanded="true"> <span
                                        class="nav-label"><?= change_lang("about-technart-drop-down") ?><span
                                            class="caret"></span></a>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link" id="nav_drop" href="#" data-toggle="dropdown" role="button"
                                    aria-haspopup="true" aria-expanded="true"><span
                                        class="nav-label"><?= change_lang("projects-tab") ?><span class="caret"></span></a>
                                <div class="dropdown-content">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link" id="nav_drop" href="#" data-toggle="dropdown" role="button"
                                    aria-haspopup="true" aria-expanded="true"> <span
                                        class="nav-label"><?= change_lang("researchers-drop-down") ?><span
                                            class="caret"></span></a>
                                <div class="dropdown-content">
